...
@ContextConfiguration(classes = IncomeRestTemplateClientTests.TestConfig.class)
@AutoConfigureWebClient
class IncomeRestTemplateClientTests {
	...
	@Autowired
	IncomeRestTemplateClient service;
	...
	@Import({ TimeLimiterConfigurationOnMissingBean.class, IncomeConfiguration.class})
