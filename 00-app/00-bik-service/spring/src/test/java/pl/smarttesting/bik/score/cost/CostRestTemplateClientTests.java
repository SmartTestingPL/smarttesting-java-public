...
@ContextConfiguration(classes = CostRestTemplateClientTests.TestConfig.class)
@AutoConfigureWebClient
class CostRestTemplateClientTests {
	...
	@Autowired
	CostRestTemplateClient service;
	...
	@Import({ TimeLimiterConfigurationOnMissingBean.class, CostConfiguration.class})
