...
@ContextConfiguration(classes = PersonalRestTemplateClientTests.TestConfig.class)
@AutoConfigureWebClient
class PersonalRestTemplateClientTests {
	...
	@Autowired
	PersonalRestTemplateClient service;
	...
	@Import({ TimeLimiterConfigurationOnMissingBean.class, PersonalConfiguration.class})
