...
class FraudController {
	...
	ResponseEntity<Void> fraudCheck(@RequestBody Person person) {
		log.info("Received a verification request for person [{}]", person);
		CustomerVerificationResult result = customerVerifier.verify(person);
